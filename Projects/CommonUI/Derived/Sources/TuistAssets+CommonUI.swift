...
public enum CommonUIAsset: Sendable {
  ...
  public static let lmBlack = CommonUIColors(name: "LMBlack")
    ...
    public static let lmGray04 = CommonUIColors(name: "LMGray04")
    public static let lmGray05 = CommonUIColors(name: "LMGray05")
    public static let lmGray06 = CommonUIColors(name: "LMGray06")
    public static let lmWhite = CommonUIColors(name: "LMWhite")
    public static let lmBlue01 = CommonUIColors(name: "LMBlue01")
    public static let lmBlue02 = CommonUIColors(name: "LMBlue02")
    public static let lmGreen01 = CommonUIColors(name: "LMGreen01")
    public static let lmGreen02 = CommonUIColors(name: "LMGreen02")
    public static let lmOrange00 = CommonUIColors(name: "LMOrange00")
    ...
    public static let lmPink = CommonUIColors(name: "LMPink")
    public static let lmRed = CommonUIColors(name: "LMRed")
  ...
  public static let add = CommonUIImages(name: "add")
    ...
    public static let edit = CommonUIImages(name: "edit")
    public static let message = CommonUIImages(name: "message")
    public static let next = CommonUIImages(name: "next")
    public static let next2 = CommonUIImages(name: "next2")
    public static let play = CommonUIImages(name: "play")
    public static let previous = CommonUIImages(name: "previous")
    public static let send = CommonUIImages(name: "send")
    public static let apple = CommonUIImages(name: "apple")
    public static let google = CommonUIImages(name: "google")
    public static let logo = CommonUIImages(name: "logo")
